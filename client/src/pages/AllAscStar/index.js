...
import { getAllStarSortAsc } from "../../service/api";

function AllAscStar({ hotel, i }) {
  const [count, setCount] = useState(1);
  const { isLoading, error, data } = useQuery({
    queryKey: ["hotels:::ascstar", count],
    queryFn: () => getAllStarSortAsc(count),
  });
